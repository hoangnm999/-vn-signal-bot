...
def load_previous_context(symbol: str) -> dict | None:
    ...
    try:
        ...
        logger.debug(f"load_previous_context: DB query failed: {e}")
        return None
    ...
    try:
        (sid, verdict_label, confidence_pct, price,
         bull_count, bear_count, agent_verdicts_raw, summary, created_at) = row
        ...
        logger.debug(f"load_previous_context parse error: {e}")
        return None
